...
```bash
git clone https://github.com/actionanand/angular-change-detection.git --branch 1-skeleton angular-proj-name
```

```bash
npx degit github:actionanand/angular-change-detection#1-skeleton angular-proj-name
```
